...
public class Environment
{
	...
	public static final Environment DEVELOPMENT = 
			new Environment( getDevelopmentBaseURL() + ":" + getDevelopmentPort(), "development" );
	
	// For you to use during your development and testing.
	public static final Environment TEST = 
			new Environment( "https://api.quickstream.support.qvalent.com", "test" );
	
	// For production.
	public static final Environment PRODUCTION =
			new Environment( "https://api.quickstream.westpac.com.au", "production" );
